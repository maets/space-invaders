function Intro() {
	...
	this.Scene2 = function (ctx) {
		...
		ctx.fillStyle = 'black';
		ctx.fillText('v 0.2.... gött mos i pösen!', (this._framePosX + 111), (this._framePosY + 151));

		// Set secondary text #1
		ctx.fillStyle = 'red';
		ctx.fillText('v 0.2.... gött mos i pösen!', (this._framePosX + 110), (this._framePosY + 150));
